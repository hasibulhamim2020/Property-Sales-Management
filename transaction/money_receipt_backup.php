...
if (isset($input_source['flat']) && $input_source['flat'] > 0) {
...
if (isset($_POST['save']) && isset($_REQUEST['count']) && $_REQUEST['count'] > 0) {
    ...
    $msg = "Money receipt generated successfully for " . $flat_no;
    $type = 1;
}
?>
...
.process-step.active .step-label { color: #679435; }
.process-step.completed .step-icon {
    background: #679435;
    border-color: #679435;
    color: white;
}
.process-step.completed::after { background: #679435; }
</style>
                ...
                <?php if (isset($msg)): ?>
                    <div class="alert alert-<?= $type == 1 ? 'success' : 'danger' ?> shadow-sm mb-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <span><?= $msg ?></span>
                            <?php if ($type == 1): ?>
                                <a href="flat_allotment.php" class="btn btn-sm btn-light font-weight-bold ml-3">
