...
function getData2(url, targetElement, projCode, sectionId) {
    ...
    xhr.open('GET', url + '?proj_code=' + projCode, true);
    xhr.send();
}
</script>
...
<div class="container-fluid p-0">
                ...
                <form id="form1" name="form1" method="post" action="<?= $page ?>">
                    ...
                    <div class="form-group row m-0 pl-3 pr-3">
                        ...
                        <div class="col-sm-9 p-0">
                            <select name="proj_code" id="proj_code" class="form-control" onchange="this.form.submit();">
    ...
    <!-- Status Results -->
    <?php 
    if (isset($_POST['submit']) && $proj_code > 0) { 
        // Summary counts
        ...
        if ($summary_res) {
            while($row = mysqli_fetch_object($summary_res)) {
                ...
                if ($status == '' || $status == 'NULL') $status = 'Available';
                    ...
                    <div class="flat-grid">
                        ...
                        while ($data = mysqli_fetch_object($flat_query)) {
                            ...
                            if($data->status == 'Booked') {
                                ...
                                $link = "party_info.php?fid=" . $data->fid;
                            ...
                            $display_status = $data->status ?: 'Available';
                            ?>
                            <a href="<?= $link ?>" 
