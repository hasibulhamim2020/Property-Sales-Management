...
$title='Work Title Add';
$unique='id';
$unique2='work_title';
$unique3='work_title_detail';
$table='tbl_work_title';
$page="work_title.php";
                                  ...
                                  <td><div class="box">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <tr>
                                       ...
                                       <tr>
                                        <td>Work Title Description:</td>
                                        <td>
										  <textarea name="<?=$unique3?>" cols="" id="<?=$unique3?>"><?=$$unique3?></textarea>                                        </td>
									  </tr>
                                    </table>
                                  </div></td>
                                </tr>
