...
$title='Floor Head Add';
$unique='id';
$unique2='floor_head';
$unique3='floor_head_detail';
$table='tbl_floor_head';
$page="floor_head.php";
                                  ...
                                  <td><div class="box">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <tr>
                                       ...
                                       <tr>
                                        <td>Floor Head Description:</td>
                                        <td>
										  <input name="<?=$unique3?>" type="text" id="<?=$unique3?>" value="<?=$$unique3?>" size="" />                                        </td>
									  </tr>
                                    </table>
                                  </div></td>
                                </tr>
