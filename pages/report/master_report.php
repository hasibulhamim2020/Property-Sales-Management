...
$qu = mysql_fetch_object(mysql_query($se));
...
echo $r->flat_size; ?>
    ...
    <td bgcolor="#CCCCCC"><? 
$query = 'select i.pre_house,i.pre_road from tbl_flat_info f, tbl_party_info i where f.party_code=i.party_code and f.fid='.$_POST['flat'];$r = mysql_fetch_object(mysql_query($query)); echo $r->pre_house.','.$r->pre_road; ?></td>
    </tr>
  <tr>
    <td>Flat No </td>
    <td><div align="left">
...
echo $r->road_no.' Floor ,'.$r->flat_no; ?>
  ...
  <tr>
    ...
    <td bgcolor="#CCCCCC"><b>
      <? $queryy = 'select f.total_price from tbl_flat_info f where  f.fid='.$_POST['flat'];$ry = mysql_fetch_object(mysql_query($queryy)); 
...
$receipt_count = mysql_num_rows($query2);
if($receipt_count!=0){
$c=0;
while($info= mysql_fetch_object($query2)){ $c++;
