...
$flat=$_POST['flat'];
 ...
 $sql="select a.*,b.team_leader,b.sr_executive,b.group_leader,b.others,b.non_insentive,b.payment_type from 

 tbl_flat_info a,tbl_party_info b where a.party_code=b.party_code and fid=".$flat." limit 1";
...
$party = mysql_fetch_object($mquery);
...
('$rec_no','$pay_code', '$no_inst','$flat', '$inst_amt', '$rec_amount','$p_by','$remarks',
...
$sql3="UPDATE `tbl_flat_cost_installment` SET `rec_no` = '".$rec_no."',`rcv_date` = '".$rec_date."', 
...
('$rec_no', '$rec_date', '$party_code','$flat_no', '$desc', '$pay_mode', '$cheq_no','$flat', '$cheq_date', '$bank_name', '$branch', '$total_amount', '$manual_no','$remarks')";
                      ...
                      <td valign="top">
					   ...
					   <div>
						   ...
						   <div>
                                          ...
                                          <label for="fname">Allot/Plot no. : </label>
				  ...
				  <table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      ...
                      <tr>
                        ...
                        <td align="center"><select name="pay_code" id="pay_code" class="input3" style="width:200px;" onchange="set_install(<?=$flat?>,this.value);">
                          ...
                          <? $sql='select distinct a.pay_code,a.pay_desc from tbl_payment_head a, tbl_flat_cost_installment b,tbl_flat_info c where a.pay_code=b.pay_code and b.fid=c.fid and c.fid='.$flat;
