...
$road_sql="select road_no,count(flat_no) as total_flat from tbl_flat_info where proj_code='$proj_code' and section_name='$section_name' group by road_no";
...
echo '<tr>';
echo '<td  style="background:#595757; height:25px; color:white;" colspan="'.$road_data->total_flat.'">Road No : ' .$road_no.'</td>';

echo '</tr>';
echo '<tr>';


$sql="select fid,party_code,build_code,flat_no,status from tbl_flat_info where road_no=$road_no and proj_code='$proj_code' and section_name='$section_name'";
/*echo $sql="select flat_no from tbl_flat_info where proj_code='$proj_code' and section_name='$section_name'";*/
...
echo '<td class="purple"><a href = "party_info.php?party_code='.$data->party_code.'" title = "Party Information" rel = "gb_page_center[480, 320]">'.$data->flat_no.'</a></td>';

elseif($data->status == 'Reserved')
echo '<td class="yallow"><a href = "party_info.php?party_code='.$data->party_code.'" title = "Party Information" rel = "gb_page_center[480, 320]">'.$data->flat_no.'</a></td>';

elseif($data->status == 'Sold')
echo '<td class="red"><a href = "party_info.php?party_code='.$data->party_code.'" title = "Party Information" rel = "gb_page_center[480, 320]">'.$data->flat_no.'</a></td>';

else
echo '<td class="blue"><a href = "../setup/party_info.php?flat_no='.$data->flat_no.'&build_code='.$data->build_code.'" title = "Party Information" rel = "gb_page_center[800, 560]">'.$data->flat_no.'</a></td>';
}
echo '</tr>';
}
