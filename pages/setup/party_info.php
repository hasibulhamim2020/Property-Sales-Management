...
document.location.href = 'party_info2.php?party_code='+lk+'&type='+k;}
</script>
        ...
        <td >&nbsp;</td>
								  ...
								  <tr>
                                    <td><div class="tabledesign"><span id="fid">
										...
										$res='select party_code,party_code,party_name from '.$table;
...
<!--									  <tr>
                                        <td >Non Insentive : </td>
                                        <td><select name="non_insentive" id="non_insentive">
									  ...
									  <!-- <tr>
                                        ...
                                        <td><select name="team_leader" id="team_leader">
                                            <? foreign_relation('personnel_basic_info','PBI_ID','PBI_NAME',$team_leader);?></select>                                       </td>
									  </tr>
									  
									  <tr>
                                        <td >Group Leader : </td>
                                        <td><select name="group_leader" id="group_leader">
                                            <? foreign_relation('personnel_basic_info','PBI_ID','PBI_NAME',$group_leader);?></select>                                        </td>
									  </tr>
									  <tr>
                                        <td >Others : </td>
                                        <td><select name="others" id="others">
                                            <? foreign_relation('personnel_basic_info','PBI_ID','PBI_NAME',$others);?></select>                                      </td>
									  </tr>-->
                                    </table>
                                  </div></td>
                                </tr>
...
<td>
<? if(isset($_GET[$unique])){?>
<input name="update" type="button" id="update" value="Book On Him!" class="btn" onclick="send(1);"/></td>
<td>
<input name="update" type="button" id="update" value="Reserve On Him!" class="btn" onclick="send(2);"/>
<? }?></td>
<td>
	<? if(isset($_GET[$unique])){?>
