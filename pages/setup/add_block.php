...
$title='Add Block';            // Page Name and Page Title

$page="add_block.php";        // PHP File Name



$table='add_block';        // Database Table Name Mainly related to this page

$unique='block_id';            // Primary Key of this Database table

$shown='block_name';                // For a New or Edit Data a must have data field
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    ...
                                    <div class="tabledesign">
                                     ...
                                     <?
									$res="select block_id,block_id,block_name from add_block";
									
                                     echo $crud->link_report($res,'add_block.php?block_id=');?>
                                  ...
                                  <tr>
                                    ...
                                    <fieldset>
                                        ...
                                        <div>
                                          ...
                                          <input name="block_name" type="text" id="block_name" value="<?=$block_name?>">
