...
foreign_relation('tbl_building_info','bid','category',$build_code);?>
							...
							{
							$res='select type_id,type,total_flat,flat_size from '.$table.' where proj_code='.$_POST['proj_code'].' and build_code='.$_POST['build_code'];
							}
							else
							if(isset($proj_code))
							$res='select type_id,type,total_flat,flat_size from '.$table.' where proj_code='.$proj_code.' and build_code='.$build_code;

							if(isset($res))
							echo $crud->link_report($res,'');
							else
							{?>
							<table width="100%" cellspacing="0" cellpadding="0" id="grp"><tbody><tr><th>Type</th>
							<th>No. Allot. </th>
							<th>Allot. Size</th>
							</tr><tr><td>&nbsp;</td><td>&nbsp;</td>
							<td>&nbsp;</td>
...
foreign_relation('tbl_building_info','bid','category',$build_code);?>
                  ...
                  <tr>
                    <td valign="top">Initiate Letter  (Like: A) :</td>
