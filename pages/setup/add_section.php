...
$title='Add Section';            // Page Name and Page Title
$page="add_section.php";        // PHP File Name
$table='add_section';        // Database Table Name Mainly related to this page
$unique='section_id';            // Primary Key of this Database table
$shown='section_name';                // For a New or Edit Data a must have data field
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    ...
                                    <div class="tabledesign">
                                        ...
                                        <? 
										 $res='select section_id,section_id,section_name from add_section';
									
                                            echo $crud->link_report($res,'add_section.php?section_id=');?>
                                  ...
                                  <tr>
                                    ...
                                    <fieldset>
                                        ...
                                        <div>
                                          ...
                                          <input name="section_name" type="text" id="section_name" value="<?=$section_name?>">
...
<? foreign_relation('tbl_project_info','proj_code','proj_name',$proj_id);?>
									...
									<div>
									 ...
									 <label>Project Name:</label>
										  ...
										  <? foreign_relation('tbl_project_info','proj_code','proj_name',$proj_id,'1 and proj_code="6"');?>
