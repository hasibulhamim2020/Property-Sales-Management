...
{		$crud->insert();
		...
		$group_name=$_POST['under_ledger'];	
		
		$id=under_ledger_id($group_name);	
		$item_name=$_POST['party_name'].'-('.$id.')';	
		if(($id%1000)==0)
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top"><div class="left">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tr>
								    <td><div class="box3"><form id="form2" name="form2" method="post" action="">
...
<input style="width:155px" name="under_ledger" type="text" id="under_ledger" value="" />
<input type="button" name="Button" value="Go" class="go" onclick="Do_Nav()" />
                                            </td>
                                      </tr>
                                      <tr>
                                        <td >Client Name</td>
