...
<? foreign_relation('tbl_project_info','proj_code','proj_name',$proj_code);?>
								  ...
								  <tr>
                                    <td><div class="tabledesign">
                                        <? 
										if(isset($proj_code))
										$res='select party_code,party_code as code,party_name as account_name from '.$table.' where proj_code='.$proj_code;
										else
										$res='select party_code,party_code as code,party_name as account_name from '.$table;
										$link=$page.'?pay_code=';
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td>                                   
							    <table width="100%" border="0" cellspacing="0" cellpadding="0">
								  ...
								  <tr>
									<td>
									<fieldset>
                                        <legend>7. Account Holders' Contact Info </legend>
                                    <div>
								  ...
								  <tr>
									<td>
									<fieldset>
                                        <legend>8. Account Holders' Present Address  </legend>
                                    <div>
                             ...
                             <tr>
                               <td>
							   <fieldset>
                                        <legend>9. Account Holders' Permanent Address</legend>
                               <div>
                             ...
                             <tr>
							   ...
							   <div>
										...
										<div>
                                          <label>25. Account Dealt by:</label>
                             ...
                             <tr>
                               <td>
							   <fieldset>
                                        <legend> Agent Employee </legend>
                               
										<div>
                                          <label>30. Zonal Incharge: </label>
                                         <input name="agent_code1" type="text" id="agent_code1" value="<?=$agent_code1?>" />
										</div>
										<label>31. Zonal Manager:</label>
                                          <input name="agent_code2" type="text" id="agent_code2" value="<?=$agent_code2?>" />
										</div>
										<label>32. Unit Officer:</label>
                                         <input name="agent_code3" type="text" id="agent_code3" value="<?=$agent_code3?>" />
										</div>
										<label>33. Agent: </label>
                                         <input name="agent_code4" type="text" id="agent_code4" value="<?=$agent_code4?>" />
										</div>
								 </fieldset>
