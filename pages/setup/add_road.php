...
$title='Add Road';            // Page Name and Page Title

$page="add_road.php";        // PHP File Name



$table='add_road';        // Database Table Name Mainly related to this page

$unique='road_id';            // Primary Key of this Database table

$shown='road_no';                // For a New or Edit Data a must have data field
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    ...
                                    <div class="tabledesign">
                                     ...
                                     <?   
									  $res='select a.road_id,a.road_no,b.block_name, c.proj_name from add_road a,add_block b ,tbl_project_info c where a.block_id=b.block_id and a.proj_id=c.proj_code';
									 

                                       echo $crud->link_report($res,'add_road.php?road_id=');?>
                                  ...
                                  <tr>
                                    ...
                                    <fieldset>
                                        ...
                                        <div>
                                          ...
                                          <input name="road_no" type="text" id="road_no" value="<?=$road_no?>">
