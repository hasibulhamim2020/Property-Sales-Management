...
<div class="wrapper">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">  
			  <tr>
				<td>				<img src="../../logo/cropped-logo-modhu.png" width="359" height="72" border="0" /></td>
				<td valign="top"><div class="header2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top" class="title"><div align="right">
                      <p class="style1"><?=find_a_field('user_activity_management','fname','user_id='.$_SESSION['user']['id']);?></p>
                    </div></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
			...
			<div class="top_bar"><table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					<td><div class="wel"><a href="<?=WEBSITE_LINK?>" target="_blank"><?=POWERED_BY?></td>
					<td>
