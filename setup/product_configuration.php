        ...
        <div class="col-md-5 p-3" style="background: rgba(255,255,255,0.5);">
            <div class="container n-form1 p-3 mb-4">
                <form method="post" action="<?= $page ?>">
                    ...
                    <div class="form-group mb-2">
                        <label class="small font-weight-bold">Select Block</label>
                        <span id="section_span">
                            <?php 
                            $_REQUEST['proj_code'] = $filter_proj;
                            $_REQUEST['section_name'] = $filter_section; // Reusing variable for Block Code
            ...
            <div class="card-modern shadow-sm overflow-hidden">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-hover mb-0" style="font-size: 13px;">
                        ...
                        <tbody>
                            <?php 
                            // $query = "SELECT a.fid, a.b_type, a.cat_id, a.road_no, a.flat_no 
                            //           FROM tbl_flat_info a
                            //           WHERE 1=1";
                            // if($filter_proj > 0) $query .= " AND a.proj_code = '$filter_proj'";
                            // if($filter_section > 0) $query .= " AND a.cat_id = '$filter_section'";
            ...
            c.cat_name
          FROM tbl_flat_info a
          LEFT JOIN tbl_add_category c ON a.cat_id = c.cat_id
          WHERE 1=1";
...
$res = db_query($query);
                            ...
                            if ($res && mysqli_num_rows($res) > 0) {
                                while($row = mysqli_fetch_object($res)) {
                                    ...
                                    <tr class="<?= $active_class ?>" onclick="DoNav(<?= $row->fid ?>)" style="cursor:pointer">
                                        <!-- <td><?= htmlspecialchars($row->proj_code) ?></td> -->
                                        ...
                                        <td><?
                                        // htmlspecialchars($row->road_no)
                                        $road = htmlspecialchars($row->road_no);
                                        if ($road == 1) {
                                            echo "1st Floor";
                                        } else {
                                            echo $road . "th Floor";
        ...
        <div class="col-md-7 p-3">
            <?php if (isset($msg)): ?>
                <div class="alert alert-<?= $msg_type == 'success' ? 'success' : 'warning' ?> shadow-sm mb-4">
                    <div class="d-flex align-items-center justify-content-between">
                        <span><?= $msg ?></span>
                        <?php if ($msg_type == 'success'): ?>
                            <a href="../transaction/flat_allotment.php" class="btn btn-sm btn-light font-weight-bold ml-3">
                                <i class="fas fa-th-large mr-1"></i> View Allotment Dashboard
                            </a>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <form method="post" id="mainForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label class="small font-weight-bold">Project</label>
                            <select name="proj_code" id="proj_code" class="form-control" onchange="getData2('product_configuration_section_ajax.php', 's_type_span', this.value, '');">
                                <option value="">-- Select Project --</option>
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <span id="cat_id_span">
                                <select name="cat_id" id="cat_id" class="form-control">
                                    ...
                                    // if ($p_code > 0) {
                                    //     foreign_relation('tbl_building_info', 'build_code', 'build_code', $build_code);
                                    // }
                                    ?>
                                    <?php foreign_relation('tbl_add_category', 'cat_id', 'cat_name', $cat_name, 1); ?>
                                </select>
                            </span>
                        </div>
                        <div class="col-md-4 form-group">
                            ...
                            <span id="b_type_span">
                                <select name="build_code" id="build_code" class="form-control">
                                    ...
                                    // }
                                    ?>
                                    <?php foreign_relation('tbl_building_info', 'bid', 'build_code', $build_code, 1); ?>
                                </select>
                            </span>
                        </div>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="number" name="road_no" value="<?= isset($road_no) ? htmlspecialchars($road_no) : '' ?>" class="form-control">
                        </div>
                        <div class="col-md-4 form-group">
